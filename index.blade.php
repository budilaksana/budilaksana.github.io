...
<head>
  ...
  <!-- Google Fonts -->
  <link href="{{ url('frontend/https://fonts.googleapis.com/css?family=Montserrat:300,400,500,700|Open+Sans:300,300i,400,400i,700,700i') }}" rel="stylesheet">
  ...
  <link href="{{ url('frontend/lib/magnific-popup/magnific-popup.css') }}" rel="stylesheet">
...
<body>
  ...
  <section id="intro">
    ...
    <div class="intro-text">
      <h2>Hallo </h2>
      <p>Selamat datang di profile Budi Laksana</p>
    ...
    <div class="product-screens">
      ...
      <div class="product-screen-1 wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="0.6s">
        <img src="{{ url('frontend/img/product-screen-1.png') }}" alt="">
      </div>

      <div class="product-screen-2 wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="0.6s">
        <img src="{{ url('frontend/img/product-screen-2.png') }}" alt="">
      </div>

      <div class="product-screen-3 wow fadeInUp" data-wow-duration="0.6s">
        <img src="{{ url('frontend/img/product-screen-3.png') }}" alt="">
      </div>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-6 about-img wow fadeInLeft">
            <img src="{{ url('frontend/img/about-img.jpg') }}" alt="">
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-5 features-img">
            <img src="{{ url('frontend/img/product-features.png') }}" alt="" class="wow fadeInLeft">
          </div>
    ...
    <section id="advanced-features">
      ...
      <div class="features-row section-bg">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <img class="advanced-feature-img-right wow fadeInRight" src="{{ url('frontend/img/advanced-feature-1.jpg') }}" alt="">
      ...
      <div class="features-row">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <img class="advanced-feature-img-left" src="{{ url('frontend/img/advanced-feature-2.jpg') }}" alt="">
      ...
      <div class="features-row section-bg">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <img class="advanced-feature-img-right wow fadeInRight" src="{{ url('frontend/img/advanced-feature-3.jpg') }}" alt="">
              <div class="wow fadeInLeft">
                <h2>Duis aute irure dolor in reprehenderit in voluptate velit esse</h2>
                <h3>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</h3>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</p>
    ...
    <section id="clients">
      <div class="container">
        ...
        <div class="row wow fadeInUp">
          ...
          <div class="col-md-2">
            <img src="{{ url('frontend/img/clients/client-1.png') }}" alt="">
          </div>

          <div class="col-md-2">
            <img src="{{ url('frontend/img/clients/client-2.png') }}" alt="">
          </div>

          <div class="col-md-2">
            <img src="{{ url('frontend/img/clients/client-3.png') }}" alt="">
          </div>

          <div class="col-md-2">
            <img src="{{ url('frontend/img/clients/client-4.png') }}" alt="">
          </div>

          <div class="col-md-2">
            <img src="{{ url('frontend/img/clients/client-5.png') }}" alt="">
          </div>

          <div class="col-md-2">
            <img src="{{ url('frontend/img/clients/client-6.png') }}" alt="">
          </div>
      ...
      <div class="container">
        ...
        <div class="row wow fadeInUp">
          <div class="col-lg-3 col-md-6">
            <div class="member">
              <div class="pic"><img src="{{ url('frontend/img/team/team-1.jpg') }}" alt=""></div>
              <h4>Walter White</h4>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="member">
              <div class="pic"><img src="{{ url('frontend/img/team/team-2.jpg') }}" alt=""></div>
              <h4>Sarah Jhinson</h4>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="member">
              <div class="pic"><img src="{{ url('frontend/img/team/team-3.jpg') }}" alt=""></div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="member">
              <div class="pic"><img src="{{ url('frontend/img/team/team-4.jpg') }}" alt=""></div>
              <h4>Amanda Jepson</h4>
        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item wow fadeInUp">
              <a href="{{url('frontend/img/gallery/gallery-1.jpg') }}" class="gallery-popup">
                <img src="{{url('frontend/img/gallery/gallery-1.jpg') }}" alt="">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item wow fadeInUp">
              <a href="{{url('frontend/img/gallery/gallery-2.jpg') }}" class="gallery-popup">
                <img src="{{url('frontend/img/gallery/gallery-2.jpg') }}" alt="">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item wow fadeInUp">
              <a href="{{url('frontend/img/gallery/gallery-3.jpg') }}" class="gallery-popup">
                <img src="{{url('frontend/img/gallery/gallery-3.jpg') }}" alt="">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item wow fadeInUp">
              <a href="{{url('frontend/img/gallery/gallery-4.jpg') }}" class="gallery-popup">
                <img src="{{url('frontend/img/gallery/gallery-4.jpg') }}" alt="">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item wow fadeInUp">
              <a href="{{url('frontend/img/gallery/gallery-5.jpg') }}" class="gallery-popup">
                <img src="{{url('frontend/img/gallery/gallery-5.jpg') }}" alt="">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item wow fadeInUp">
              <a href="{{url('frontend/img/gallery/gallery-6.jpg') }}" class="gallery-popup">
                <img src="{{url('frontend/img/gallery/gallery-6.jpg') }}" alt="">
              </a>
            </div>
          </div>
  ...
  <script src="{{ url('frontend/lib/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
  <script src="{{ url('frontend/lib/easing/easing.min.js') }}"></script>
  <script src="{{ url('frontend/lib/wow/wow.min.js') }}"></script>
  <script src="{{ url('frontend/lib/superfish/hoverIntent.js') }}"></script>
  <script src="{{ url('frontend/lib/superfish/superfish.min.js') }}"></script>
  <script src="{{ url('frontend/lib/magnific-popup/magnific-popup.min.js') }}"></script>
